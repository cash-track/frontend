export default {
    ...
    profile: {
        ...
        emailNotConfirmedMainMessage: 'Будь ласка, перевірте Вашу поштову скриньку, використовуючи посилання для підтвердження Email - підтверьте Ваш профіль. Наразі Ваші можливості обмежено.',
        emailNotConfirmedResendMessage: 'Ви можете надіслати лист з інструкцією для підтвердження профілю повторно з налаштувань профілю.',
