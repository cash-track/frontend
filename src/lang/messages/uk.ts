export default {
    ...
    statusPage: 'Статус',
    statusPageHint: 'Якщо це повторюється, перевірте нашу',
    statusPageHintLink: 'сторінку стану',
    ...
    duplicateRequestError: 'Ваш попередній запит ще обробляється. Будь ласка, зачекайте трохи і спробуйте ще раз.',
    idempotencyConflictError: 'Не вдалося виконати цю дію, оскільки вона змінилася з моменту попередньої спроби. Будь ласка, спробуйте ще раз.',
