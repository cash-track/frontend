<template>
  <div class="about">
    ...
    <blockquote class="blockquote">
      <p class="mb-0">Life is like riding a bicycle. To keep your balance, you must keep moving.</p>
    ...
    <p><b-button variant="primary" to="register">Connect</b-button> or <b-button variant="primary" to="login">Log In</b-button></p>
  </div>
</template>
